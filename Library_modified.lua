...
function Library:CreateWindow(WindowInfo)
    ...
    do
        ...
        --// Accent Glow Bar \\--
        local AccentGlowBar
        local AccentGlowTween
        if WindowInfo.ShowAccentGlow then
            local HolderHeight = math.max(WindowInfo.AccentGlowThickness, WindowInfo.CornerRadius)

            local AccentGlowHolder = New("Frame", {
                Name = "AccentGlowHolder",
                BackgroundTransparency = 1,
                Position = UDim2.fromOffset(0, 0),
            ...
            table.insert(
                ...
                New("UICorner", {
                    CornerRadius = UDim.new(0, WindowInfo.CornerRadius),
                    Parent = AccentGlowHolder,
                })
            )

            AccentGlowBar = New("Frame", {
                Name = "AccentGlowBar",
                AnchorPoint = Vector2.new(0, 1),
                BackgroundColor3 = "AccentColor",
                ...
                BorderSizePixel = 0,
                Position = UDim2.fromScale(0, 1),
                Size = UDim2.new(1, 0, 0, WindowInfo.AccentGlowThickness),
                ZIndex = 5,
                Parent = AccentGlowHolder,
            })
            ...
            New("UIGradient", {
                ...
                Parent = AccentGlowBar,
            })

            local function PlayAccentGlowTween()
                if not AccentGlowBar or not AccentGlowBar.Parent then
                    return
                end

                AccentGlowTween = TweenService:Create(
                    AccentGlowBar,
        ...
        local TabHeaderLabelX = Library:GetTextBounds("Tab", Library.Scheme.Font, 14, 60)
        local TabHeaderLabel = New("TextLabel", {
            Name = "TabHeaderLabel",
            BackgroundTransparency = 1,
            Size = UDim2.new(0, TabHeaderLabelX, 1, 0),
            Text = "Tab",
            TextSize = 14,
            TextTransparency = 0.4,
